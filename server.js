...
const systemPrompt = `You are ${agent.name} - an elite expert in your domain. Your role: ${role}. ${langInstruction} Respond with substance and depth (max ${maxWords} words). Focus only on your specific role - provide unique value that other agents cannot. No fluff, no generic statements. Every sentence must add insight.`;
...
1. Mark DISSENT clearly when agents fundamentally disagree
1. Highlight CONSENSUS on key points
1. Include the Futurist’s long-term implications
1. Address the Devil’s Advocate’s strongest challenges
1. Be decisive - give clear conclusions, not hedged opinions
1. Maximum 500 words - every word must earn its place
1. End with “Confidence: X/10” and brief justification
1. If relevant, suggest ONE concrete next action`;
